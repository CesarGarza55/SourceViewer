...
!define APPNAME "SourceViewer"
!define DESCRIPTION "SourceViewer is a Python application built using customtkinter that allows you to visualize video and audio sources connected to your computer. The application provides an easy-to-use interface to select, view, and listen to your media sources."
...
!define HELPURL "https://github.com/CesarGarza55/SourceViewer"
!define UPDATEURL "https://github.com/CesarGarza55/SourceViewer/releases/latest/download/SourceViewer.exe"
!define ABOUTURL "https://github.com/CesarGarza55/SourceViewer"
!define INSTALLSIZE 259072
...
Section "install"
  ...
  CreateShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\SourceViewer.exe"
  CreateShortCut "$SMPROGRAMS\${APPNAME}\uninstall.lnk" "$INSTDIR\uninstall.exe"
  CreateShortCut "$DESKTOP\${APPNAME}.lnk" "$INSTDIR\SourceViewer.exe"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${APPNAME}" "DisplayIcon" "$INSTDIR\SourceViewer.exe"
...
Section "uninstall"
  ...
  delete $INSTDIR\SourceViewer.exe
